    ...
    >
      <div className={`border-b border-sidebar-border py-5 ${collapsed ? "px-4" : "px-6"}`}>
        <div className={`flex items-center ${collapsed ? "justify-center" : "gap-3"}`}>
          <img src="/logo.svg" alt="PocketPilot" className="h-8 w-8 rounded-lg object-cover shadow-md shadow-primary/20" />
          <div className={collapsed ? "hidden" : "block"}>
            <span className="block font-serif text-base font-medium tracking-tight">
              PocketPilot
            </span>
