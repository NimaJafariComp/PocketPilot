        ...
        {goals.length > 0 ? (
          <SummaryStrip
            items={[
              ...
              {
                label: "Done",
                value: `${model.completedCount}/${goals.length}`,
            ...
            >
                ...
                <View
                  ...
                  style={{
                    backgroundColor: isComplete
                      ? colors.sectionAccents.goals.chipBackground
                      : goalPalette.chipBackground,
                  }}
                >
                  <Text
                    className="text-[12px]"
              ...
              {chartData.length > 1 ? (
                <View className="mt-3">
                  <Sparkline
                    ...
                    fillColor={
                      isComplete ? colors.sectionAccents.goals.chipBackground : goalPalette.fill
                    }
                  />
                </View>
              ) : null}
              ...
              {!isComplete ? (
                <Pressable
                  ...
                  onPress={() => { hapticSelect(); router.push(`/goals/${goal.id}/contribute` as never); }}
                >
                  <Text
